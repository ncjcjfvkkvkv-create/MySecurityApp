...
class CSForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val title = intent?.getStringExtra("title") ?: "YourNewAppName Antivirus"
            ...
            .setMethodCallHandler { call, result ->
                when (call.method) {
                    "startService" -> {
                        ...
                        val title = args?.get("title") as? String ?: "YourNewAppName"
    ...
    private fun createNotification(title: String, text: String) {
        ...
        val summary = notificationBuilder(channelId)
            .setContentTitle("YourNewAppName")
