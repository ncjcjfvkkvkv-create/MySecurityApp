...
class SettingsScreenState extends State<SettingsScreen>
  ...
  void _showAboutYourNewAppNamePopup() {
    showDialog(
      context: context,
      builder: (context) {
        return const AlertDialog(
          ...
          content: Text(
            'YourNewAppName is a mobile security suite created by ColourSwift Tech, based in Birmingham, UK.\n\n'
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                onPressed: () async {
                  final uri = Uri.parse(
                    'https://github.com/ColourSwift/YourNewAppName-Security',
                  );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SettingsSettingTile(
                      ...
                      subtitle: 'v4.0.5',
                      onTap: _showAboutYourNewAppNamePopup,
                    ),
                    if (kDebugMode)
                      SettingsSettingTile(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          signedIn
                              ? (accountId == null ? 'YourNewAppName account connected' : 'Account ID: $accountId')
                ...
                if (!signedIn)
                  SettingsSettingTile(
                    ...
                    title: 'Sign in',
                    subtitle: 'Open the YourNewAppName account portal',
