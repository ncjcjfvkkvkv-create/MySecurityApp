...
class AvHomeScreenState extends State<AvHomeScreen>
  ...
  Future<void> _openVpnAppStoreListing() async {
    if (kGithubBuild) {
      final url = Uri.parse('https://github.com/YourGitHubUsername/YourNewAppName-VPN');
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const _YourNewAppNameSecurityFooter(),
                      ],
                    ),
                  ),
                ],
...
class _YourNewAppNameSecurityFooter extends StatelessWidget {
  const _YourNewAppNameSecurityFooter();
