...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get appName => 'YourNewAppName';
  ...
  @override
  String get companionAppsSectionTitle => 'More from YourNewAppName';
  ...
  @override
  String get onboardingAppName => 'YourNewAppName Security';
  ...
  String get networkModeMalwareDescription =>
      'يجمع بين قاعدة بيانات البرمجيات الخبيثة المحلية لدى YourNewAppName ومعلومات التهديدات عبر الإنترنت من Cloudflare لأقصى حماية.';
  ...
  String get networkModeAdultDescription =>
      'يستخدم قاعدة بيانات البرمجيات الخبيثة غير المتصلة لدى YourNewAppName ويضيف فلترة محتوى للبالغين. يتم تعطيل ذكاء البرمجيات الخبيثة السحابي في هذا الوضع.';
  ...
  @override
  String get homeFeatureSecureVpnTitle => 'YourNewAppName Secure VPN';
  ...
  @override
  String get settingsAboutApp => 'حول YourNewAppName';
  ...
  String get scheduledPreferredTimeSubtitle =>
      'سيحاول YourNewAppName البدء قرب هذا الوقت. قد يؤخره Android لتوفير البطارية.';
